...
func generateCompanionEphemeralKey(linkCode ...string) (ephemeralKeyPair *keys.KeyPair, ephemeralKey []byte, encodedLinkingCode string) {
...
func (cli *Client) PairPhone(ctx context.Context, phone string, showPushNotification bool, clientType PairClientType, clientDisplayName string, linkCode ...string) (string, error) {
	...
	ephemeralKeyPair, ephemeralKey, encodedLinkingCode := generateCompanionEphemeralKey(linkCode...)
